...
function [MultiplePaths,finalPath,FinalSmoothedPath,riskExposureLevels]...
    ...
    Constraints,plotBranches,RecordVideo,randNodeExtProb,p_quasi,pathFigs)
...
% Delay between iteration displays
    ...
    if isempty(MultiplePaths) % if no path has found, grow trees until you found
        [success,Tree1,Tree2,pathTree1,pathTree2,NodeIDsuccess_1,NodeIDsuccess_2]...
            = bi_RRTstar(mapSize, start, finish,distThresh, stepSize, goalProb, figHandle,...
            Velocity,PREM,dX,dY,PURM,X_Grid,Y_Grid,Population,goalProbTree2,RiskThreshold,obstacles,ResMapSize,...
            Constraints,plotBranches,randNodeExtProb,pathTree1,pathTree2,Tree1,Tree2,gama,p_quasi,iter,alpha);
...
function [success,Tree1,Tree2,pathTree1,pathTree2,NodeIDsuccess_1,NodeIDsuccess_2]...
    = bi_RRTstar(mapSize, start, finish,distThresh, stepSize, goalProb, figHandle,...
    Velocity,PREM,dX,dY,PURM,X_Grid,Y_Grid,Population,goalProbTree2,RiskThreshold,obstacles,ResMapSize,...
    Constraints,plotBranches,randNodeExtProb,pathTree1,pathTree2,Tree1,Tree2,gama,p_quasi,iter_N,alpha)
...
% %         hold on
        ...
        if rand < randNodeExtProb 
            ...
            [pathTree1,Tree1,extended_1] = Extend_1(randNode_1, target, stepSize,randNodeID_1,pathTree1,Tree1,PREM,ResMapSize,...
            ...
            [pathTree1,Tree1,extended_1] = Extend_1(nearestNode_1, target, stepSize,nearestNodeID_1,pathTree1,Tree1,PREM,ResMapSize,...
                dX,dY,PURM,X_Grid,Y_Grid,Population,RiskThreshold,obstacles,Constraints,Velocity);
...
% %             hold on
            ...
            if rand < randNodeExtProb
                ...
                [pathTree2,Tree2,extended_2] = Extend_1(randNode_2, target2, stepSize,randNodeID_2,pathTree2,Tree2,PREM,ResMapSize,...
                    dX,dY,PURM,X_Grid,Y_Grid,Population,RiskThreshold,obstacles,Constraints,Velocity);
                ...
                [pathTree2,Tree2,extended_2] = Extend_1(nearestNode_2, target2, stepSize,nearestNodeID_2,pathTree2,Tree2,PREM,ResMapSize,...
                    dX,dY,PURM,X_Grid,Y_Grid,Population,RiskThreshold,obstacles,Constraints,Velocity);
...
%                          r_2 = Dist(extended_2,PathNode_2)*cr2;
                        ...
                        [pathTree2,Tree2] = RewireNodes(pathTree2,Tree2,extendedNode_2,...
                                            ...
                                            PURM,X_Grid,Y_Grid,Population,Constraints);
...
% %         hold on
            ...
            if rand <= randNodeExtProb
                ...
                [pathTree2,Tree2,extended_2] = Extend_1(nearestNode_2, target2, stepSize,nearestNodeID_2(1),pathTree2,Tree2,PREM,ResMapSize,...
                    dX,dY,PURM,X_Grid,Y_Grid,Population,RiskThreshold,obstacles,Constraints,Velocity);
